...
# read datasets
df = pyreadstat.read_dta('/mnt/c/Users/piobl/Documents/msc_applied_mathematics/4_semester/master_thesis/data_environmental_epidemology/ije-2012-10-0989-File003.dta')
print(df)
...
fn.set(ylabel="Count")
plt.savefig("./figures/climate_freqs_m.png")
plt.clf()
